...
namespace Squadron
{
    public class MariaDBResourceTests : IClassFixture<MariaDBResource>
    {
        private readonly MariaDBResource _resource;

        public MariaDBResourceTests(MariaDBResource resource)
        {
            _resource = resource;
        }
