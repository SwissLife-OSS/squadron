...
public class TypesenseResourceTests(TypesenseResource typesenseResource) : IClassFixture<TypesenseResource>
{
    [Fact]
    public void CreateAndGetDocument_NoError()
    {
        var provider = new ServiceCollection()
            ...
            {
                config.ApiKey = typesenseResource.ApiKey;
                config.Nodes = new List<Node> { new Node("localhost", typesenseResource.Port.ToString(), "http") };
